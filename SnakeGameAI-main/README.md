...
A simple snake board game which is user controlled is designed using pygame module is here https://github.com/mr-robot77/Courses-Project/blob/main/SnakeGameAI-main/snake_game.py 
